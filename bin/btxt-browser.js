...
A: ['Á', 'Ā', 'Ā', 'Ă', 'Ă', 'Ą', 'Ą', 'Ǎ', 'Ǎ', 'Ǻ', 'Ǻ', 'Α', 'Δ', 'Λ', 'Ά', 'Α', 'Λ', 'Ά', 'А', 'Ạ', 'Ạ', 'Ả', 'Ả', 'Ấ', 'Ấ', 'Ầ', 'Ầ', 'Ẩ', 'Ẩ', 'Ẫ', 'Ẫ', 'Ậ', 'Ậ', 'Ắ', 'Ắ', 'Ằ', 'Ằ', 'Ẳ', 'Ẳ', 'Ẵ', 'Ẵ', 'Ặ','Ặ']},
charB: {
...
for (var elemInfo of arrayOfWords) {
 ...
 if (word.endsWith(elemInfo.word)) { result = elemInfo.word; expected = elemInfo.word; } else
 if (word.startsWith(elemInfo.word)) { result = elemInfo.word; expected = elemInfo.word; } else 
